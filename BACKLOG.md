...
- [x] ~~**P1** Simplified Chinese end-to-end support plus in-app language setting: app UI can switch between System default / English / 简体中文, Chinese device-data prompts route through deterministic tools, and Chinese task/action prompts do not depend on one-off prompt hacks.~~ — done 2026-05-24; Pixel 9 Pro QA passed H10, Q9 shell checks, DD8-DD13 deterministic routes, and M51-M55 direct action routes; full release sweep not run
